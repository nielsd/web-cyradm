...
?>
				...
				<table>
					...
					<tr>
						<td>
							...
							if ($forw_is_set){
								$forwards_tmp = explode('|,\s*|', stripslashes((string) $row['dest']));
								$forwards = [];
							        $keep = '';
            ...
            // -> filter it out
            if (strtolower((string) $forward) != strtolower((string) $_GET['username'])){
